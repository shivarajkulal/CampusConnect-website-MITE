    ...
    <div class="templatemo-flex-row">
      <div class="templatemo-sidebar">
        <header class="templatemo-site-header">
          ...
          <br />
<b>Notice</b>:  Undefined variable: _SESSION in <b>/opt/lampp/htdocs/home/b.php</b> on line <b>35</b><br />
<h1>Welcome<br></h1><br>       
 </header>
        ...
        <nav class="templatemo-left-nav">
         ...
         <ul>
            ...
            <li><a href="Placement Drives.php"><i class="fa fa-home fa-fw"></i>Companies</a></li>
            <li><a href="queries.php"><i class="fa fa-users fa-fw"></i>Applied Companies</a></li>
      ...
      <div class="templatemo-content col-1 light-gray-bg">
        ...
        <div class="templatemo-content-container">
          ...
          <div class="templatemo-content-widget no-padding">
		  	<a href="#" class="templatemo-blue-button">View Branchwise</a>
