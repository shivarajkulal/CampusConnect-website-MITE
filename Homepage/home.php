...
<html lang="en">
    ...
    <head>
        ...
        <!--favicon-->
        <link rel="shortcut icon" href="image1/mlogo.png" type="image/icon">
        <link rel="icon" href="../mlogo.ico" >
        <title>Mite Home</title>
        <!-- Bootstrap Core CSS -->
        ...
        <nav id="mainNav" class="navbar navbar-default navbar-fixed-top" style="background:black">
            <div class="container-fluid">
                ...
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand page-scroll" href="https://mite.ac.in/">Mangalore Institute of Technology and Engineering</a>
                </div>
            ...
            <div class="header-content">
                <div class="header-content-inner">
                    ...
                    <p >We are here to Build your Skills and Career with our Driven Passion and Reality.</br>Click Below to Get Our Current Drive
                        Details</p>
                    <a href="https://mite.ac.in/placements/" class="btn btn-primary btn-xl page-scroll">Current Drives</a>
                </div>
            </div>
        </header>
        <div class="footer">
			<div class="container">
				<div class="col-md-3 ftr_navi ftr">
				 ...
				 <div class="col-md-3 get_in_touch ftr">
					...
					<p>Badaga Mijar, Near Moodabidre,
                         Mangalore Tq, DK Dist, Karnataka - 574225</p>
					<p>+91 9741731309/ 9945130850</p>
                    <p>info@mite.ac.in</p>
					<a href="https://www.linkedin.com/company/miteedu/">Linkedin</a>
				</div>
				<div class="col-md-3 ftr-logo">
					<p>Copyright &copy; DBMS Project | MITE-2023
				</div>
