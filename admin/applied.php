...
<html lang="en">
  ...
  <div class="panel panel-default table-responsive" style="border:2px solid cyan;padding:10px;margin:10px;box-shadow:3px 3px">
                                ...
                                ?>
                                    ...
                                    <a  href=applied.php?sapid=<?php echo $sapid; ?> ><button type="button" class="templatemo-blue-button width-20" name="delete">Reject</button></a>
                              ...
                              <?php
                                if(isset($_GET['sapid'])){
                                    ...
                                    $zquery="DELETE FROM selected_stud WHERE sapid='{$g_id}'";
